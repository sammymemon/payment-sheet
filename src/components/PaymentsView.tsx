  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-semibold text-slate-800 tracking-tight">Payments Processing</h2>
          <p className="text-sm text-slate-500 mt-1">Finalize and record outbound payments.</p>
        </div>
      ...
      <div className="glass-card overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-200 bg-slate-50/50">
           <h3 className="text-base font-semibold text-slate-800">Pending Disbursements</h3>
        </div>
